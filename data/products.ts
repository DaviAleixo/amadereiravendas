...
export const products: Product[] = [
  ...
  { id: 3, slug: 'mesa-cascata-pequia-340', name: 'Mesa Cascata Pequiá', category: 'mesas-cascata', categoryLabel: 'Mesas Cascata', dimensions: '340 x 122 cm', wood: 'Pequiá', price: 15990, installments: 'R$ 16.990,00 parcelado', description: 'Mesa cascata em madeira Pequiá.', images: ['/mesacascatapequia.jpeg'] },
  { id: 5, slug: 'mesa-angelim-390', name: 'Mesa Madeira Angelim', category: 'mesas', categoryLabel: 'Mesas', dimensions: '390 x 90 cm', wood: 'Angelim', price: 12000, installments: 'R$ 12.990,00 em 10x', description: 'Acomoda até 10 pessoas.', images: ['/mesamadeiraangelim1.jpeg'] },
  ...
  { id: 8, slug: 'mesa-cascata-pequia-390', name: 'Mesa Cascata Pequiá', category: 'mesas-cascata', categoryLabel: 'Mesas Cascata', dimensions: '390 x 124/140 cm', wood: 'Pequiá', price: 12000, installments: 'R$ 12.990,00 em 10x', oldPrice: 'R$ 24.990,00', description: 'Acomoda até 12 pessoas.', images: ['/mesacascatacadeirapequia5x0,90.PNG'] },
  ...
  { id: 13, slug: 'mesa-cascata-angelim-epoxi-320', name: 'Mesa Cascata Angelim com Resina Epóxi', category: 'resina-epoxi', categoryLabel: 'Resina Epóxi', dimensions: '320 x 105 cm', wood: 'Angelim e Resina', price: 15000, installments: 'R$ 15.990,00 em 10x', oldPrice: 'R$ 18.990,00', description: 'Mesa trabalhada em resina epóxi com a beleza do Angelim e formato cascata.', images: ['/mesacascataangelimresinaepoxi 240x105.jpeg', '/mesacascataangelim240x105resinaepoxi.jpeg', '/mesacascataangelim240x105resinaepoxi1.jpeg', '/mesacascataangelim240x105resinaepoxi2.jpeg'] },
  { id: 14, slug: 'cadeira-italia', name: 'Cadeira Itália (Cor à escolha)', category: 'cadeiras', categoryLabel: 'Cadeiras', dimensions: 'Padrão', wood: 'Madeira maciça', price: 1200, installments: 'R$ 1.290,00 em 10x', oldPrice: 'R$ 1.790,00', description: 'Design clássico e conforto. IMPORTANTE: A COR É FEITA SOB ENCOMENDA, À ESCOLHA DO CLIENTE.', images: ['/cadeiraitaliacores.jpeg'] },
  ...
  { id: 21, slug: 'mesa-prancha-pequia', name: 'Mesa Prancha', category: 'pranchas', categoryLabel: 'Pranchas', dimensions: '157 x 62', wood: 'Pequiá', price: 1990, installments: 'R$ 2.490 em 10x', description: 'Mesa prancha em madeira Pequiá.', images: ['/mesapranchamadeirapequia.jpeg'] },
  ...
  { id: 24, slug: 'mesa-cascata-angelim-310', name: 'Mesa Cascata Angelim', category: 'resina-epoxi', categoryLabel: 'Resina Epóxi', dimensions: '310 x 105 cm', wood: 'Angelim', price: 15990, installments: 'R$ 16.990,00 em 10x', oldPrice: 'R$ 18.990,00', description: 'Mesa cascata em madeira Angelim trabalhada em resina epóxi.', images: ['/mesacascataangelim310X105.jpeg', '/mesacascataangelim 310X105foto-2.jpeg', '/mesacascataangelim 310X105foto3.jpeg'] },
  { id: 25, slug: 'mesa-pequia-preto', name: 'Mesa Cascata Pequiá Preto', category: 'mesas-cascata', categoryLabel: 'Mesas Cascata', dimensions: '360 x 87/84 cm', wood: 'Pequiá Preto', price: 12000, installments: '10x de R$ 1.299,00', description: 'Acomoda até 8 pessoas. Madeira de tonalidade marcante e alta durabilidade.', images: ['/pequiapreto.jpeg'] },
  { id: 26, slug: 'aparador-142', name: 'Aparador', category: 'aparadores', categoryLabel: 'Aparadores', dimensions: '142 x 60 x 89 cm de altura', wood: 'Madeira maciça', price: 2450, installments: 'R$ 2.990,00 em 10x', description: 'Aparador elegante em madeira maciça.', images: ['/aparador142x60x89.jpeg', '/aparador142x60x89foto2.jpeg', '/aparador142x60x89foto3.jpeg'] },
  { id: 27, slug: 'aparador-organico', name: 'Aparador Orgânico', category: 'aparadores', categoryLabel: 'Aparadores', dimensions: '200 x 80 cm', wood: 'Madeira maciça', price: 18000, installments: 'R$ 18.990,00 em 10x', oldPrice: 'R$ 24.990,00', description: 'Aparador orgânico com design elegante.', images: ['/aparadororganico.jpeg'] },
  { id: 28, slug: 'mesa-cascata-angelim-320-nova', name: 'Mesa Cascata Angelim com Resina Epóxi', category: 'resina-epoxi', categoryLabel: 'Resina Epóxi', dimensions: '320 x 105 cm', wood: 'Angelim e Resina', price: 15990, installments: 'R$ 16.990,00 em 10x', oldPrice: 'R$ 18.990,00', description: 'Mesa trabalhada em resina epóxi.', images: ['/fotoproduto.jpeg'] },
]

export const categories = ['Todos', 'Mesas Cascata', 'Mesas', 'Pranchas', 'Resina Epóxi', 'Bases', 'Cadeiras', 'Aparadores']
