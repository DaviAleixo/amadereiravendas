...
export const products: Product[] = [
  ...
  { id: 4, slug: 'mesa-pequia', name: 'Mesa de Madeira Pequiá', category: 'mesas', categoryLabel: 'Mesas', dimensions: '390 x 124/140 cm', wood: 'Pequiá', price: 17000, installments: '10x de R$ 1.899,00', oldPrice: 'R$ 24.990,00', description: 'Acomoda até 12 pessoas. Imponente e resistente, ideal para grandes espaços.', images: [woodImages[0], woodImages[2]] },
  ...
  { id: 7, slug: 'mesa-cascata-angelim-epoxi-310', name: 'Mesa Cascata Angelim com Resina Epóxi', category: 'resina-epoxi', categoryLabel: 'Resina Epóxi', dimensions: '310 x 105 cm', wood: 'Angelim e Resina', price: 15990, installments: '10x de R$ 1.699,00', oldPrice: 'R$ 18.990,00', description: 'Mesa em Angelim com design cascata, oferecendo amplo espaço e presença forte combinada à elegância da resina.', images: [woodImages[1], woodImages[2]] },
  ...
  { id: 11, slug: 'base-raiz-aroeira', name: 'Base Raiz Aroeira', category: 'bases', categoryLabel: 'Bases', dimensions: 'Vidro de até 200 cm', wood: 'Aroeira', price: 15000, installments: '10x de R$ 1.699,00', oldPrice: 'R$ 19.990,00', description: 'Base orgânica esculpida pelas formas naturais da raiz de Aroeira. Ideal para tampos de vidro.', images: ['/baseraizaroeira.jpeg', '/baseraizaroeira1.HEIC', '/baseraizaroeira2.HEIC', '/baseraizaroeira3.HEIC', '/baseraizaroeira4.HEIC'] },
  ...
  { id: 13, slug: 'mesa-cascata-angelim-epoxi-240', name: 'Mesa Cascata Angelim com Resina Epóxi', category: 'resina-epoxi', categoryLabel: 'Resina Epóxi', dimensions: '240 x 105 cm', wood: 'Angelim e Resina', price: 15990, installments: '10x de R$ 1.699,00', oldPrice: 'R$ 18.990,00', description: 'Mesa trabalhada em resina epóxi com a beleza do Angelim e formato cascata.', images: ['/mesacascataangelimresinaepoxi 240x105.jpeg', '/mesacascataangelim240x105resinaepoxi.HEIC', '/mesacascataangelim240x105resinaepoxi1.HEIC', '/mesacascataangelim240x105resinaepoxi2.jpeg', '/mesacascataangelim240x105resinaepoxi23.jpeg'] },
  ...
  { id: 16, slug: 'mesa-base-cumaru', name: 'Mesa Base Cumaru', category: 'mesas', categoryLabel: 'Mesas', dimensions: '240 x 125 cm', wood: 'Cumaru', price: 7000, installments: 'R$ 7.990,00 em 10x', oldPrice: 'R$ 9.990,00', description: 'Mesa robusta e elegante com base em Cumaru.', images: ['/mesabasecumaru.jpeg', '/mesabasecuaru2.jpeg', '/mesabasecumaru3.jpeg'] },
  ...
  { id: 19, slug: 'cadeira-faby-sem-braco', name: 'Cadeira Faby sem Braço', category: 'cadeiras', categoryLabel: 'Cadeiras', dimensions: 'Padrão', wood: 'Madeira maciça', price: 1190, installments: 'R$ 1.290,00 em 10x', oldPrice: 'R$ 1.590,00', description: 'Cadeira Faby, versão sem braços para maior versatilidade de espaço.', images: [woodImages[0]] },
]
